# Agent Memory — Senior Backend Developer

## Índice

- [project_sprint1_tasks.md](project_sprint1_tasks.md) — SP1-T19/T20/T21: vida, NPC, usuários
- [feedback_security_context.md](feedback_security_context.md) — Autenticação nos testes de integração
- [project_schema_changes.md](project_schema_changes.md) — Campos adicionados às entidades (sprint 1)
- [project_security_audit_sp1t18.md](project_security_audit_sp1t18.md) — SP1-T18: 2 CVEs encontrados e corrigidos em FichaService e FichaPreviewService
- [feedback_calc_service_patterns.md](feedback_calc_service_patterns.md) — Spec-007 T0: armadilhas e padrões do motor de cálculos
