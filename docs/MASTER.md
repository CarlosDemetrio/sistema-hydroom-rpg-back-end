...
| MVP objetivo | Specs 005-009+012+015+016+021+**023**+**024** implementadas e testadas |
| Total tasks MVP | **~120+** (estimado — inclui Spec 023, Spec 024, UX fixes, NPC gaps, GAPs auditoria BE->FE) |
| Specs CORTADAS | **Spec 010** (ADMIN roles), **Spec 013** (doc tecnica), **Spec 014** (cobertura testes — T2-T4+T6, cortada 2026-04-13), **PA-017-04** (export/import), **GAP-EXPRT-01** (BE sem endpoint) |
...
| **015** | **ConfigPontos Classe/Raca + DefaultProvider** | [`specs/015-config-pontos-classe-raca/`](specs/015-config-pontos-classe-raca/) | **P0** | 5B / 2F / **7** | **7/7 CONCLUIDOS** — T4 entregue Wave P0 (pre-impl + `origem` no FichaVantagemResponse, commit `4c04a54`) |
| **007** | **VantagemEfeito + Motor de Calculos** | [`specs/007-vantagem-efeito/`](specs/007-vantagem-efeito/) | **P0-ABSOLUTA** | 9B / 4F / **13** | **13/13 CONCLUIDOS** — T10 FE entregue Wave P0 (FormulaEditor, 54 testes). T5alt DESBLOQUEADO. |
...
| 024 — UX Melhorias Sprint 4 | [`spec.md`](specs/024-ux-melhorias-sprint4/spec.md), [`plan.md`](specs/024-ux-melhorias-sprint4/plan.md), [`tasks/INDEX.md`](specs/024-ux-melhorias-sprint4/tasks/INDEX.md) — **2 tasks CONCLUIDAS** (T1 entregue R17 +14 testes; T2 via Spec 023 FE) |
